...
func New(talosClientFactory *talos.ClientFactory, dnsService *dns.Service, workloadProxyServiceRegistry *workloadproxy.ServiceRegistry,
	...
	qcontrollers := []controller.QController{
		...
		omnictrl.NewClusterMachineTeardownController(config.Config.EmbeddedDiscoveryService.Enabled, config.Config.EmbeddedDiscoveryService.Port),
		...
		omnictrl.NewDiscoveryServiceConfigPatchController(config.Config.EmbeddedDiscoveryService.Enabled, config.Config.EmbeddedDiscoveryService.Port),
